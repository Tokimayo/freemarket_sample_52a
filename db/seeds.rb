...
Size.create(name: "M", category_flag: 1)
Size.create(name: "L", category_flag: 1)
Size.create(name: "XL(LL)", category_flag: 1)
Size.create(name: "2XL(3L)", category_flag: 1)
Size.create(name: "3XL(4L)", category_flag: 1)
Size.create(name: "4XL(5L)以上", category_flag: 1)
Size.create(name: "FREE SIZE", category_flag: 1)
Size.create(name: "20cm以下", category_flag: 2)
Size.create(name: "20.5cm", category_flag: 2)
Size.create(name: "21cm", category_flag: 2)
Size.create(name: "21.5cm", category_flag: 2)
Size.create(name: "22cm", category_flag: 2)
Size.create(name: "22.5cm", category_flag: 2)
Size.create(name: "23cm", category_flag: 2)
Size.create(name: "23.5cm", category_flag: 2)
Size.create(name: "24cm", category_flag: 2)
Size.create(name: "24.5cm", category_flag: 2)
Size.create(name: "25cm", category_flag: 2)
Size.create(name: "25.5cm", category_flag: 2)
Size.create(name: "26cm", category_flag: 2)
Size.create(name: "26.5cm", category_flag: 2)
Size.create(name: "27cm", category_flag: 2)
Size.create(name: "27.5cm以上", category_flag: 2)
Size.create(name: "60cm", category_flag: 3)
Size.create(name: "70cm", category_flag: 3)
Size.create(name: "80cm", category_flag: 3)
Size.create(name: "90cm", category_flag: 3)
Size.create(name: "95cm", category_flag: 3)
Size.create(name: "100cm", category_flag: 4)
Size.create(name: "110cm", category_flag: 4)
Size.create(name: "120cm", category_flag: 4)
Size.create(name: "130cm", category_flag: 4)
Size.create(name: "140cm", category_flag: 4)
Size.create(name: "150cm", category_flag: 4)
Size.create(name: "160cm", category_flag: 4)
Size.create(name: "10.5cm以下", category_flag: 5)
Size.create(name: "11cm・11.5cm", category_flag: 5)
Size.create(name: "12cm・12.5cm", category_flag: 5)
Size.create(name: "13cm・1.35cm", category_flag: 5)
Size.create(name: "14cm・14.5cm", category_flag: 5)
Size.create(name: "15cm・15.5cm", category_flag: 5)
Size.create(name: "16cm・16.5cm", category_flag: 5)
Size.create(name: "17cm以上", category_flag: 5)
Size.create(name: "135cm-140cm未満", category_flag: 6)
Size.create(name: "140cm-145cm未満", category_flag: 6)
Size.create(name: "145cm-150cm未満", category_flag: 6)
Size.create(name: "150cm-155cm未満", category_flag: 6)
Size.create(name: "155cm-160cm未満", category_flag: 6)
Size.create(name: "160cm-165cm未満", category_flag: 6)
Size.create(name: "165cm-170cm未満", category_flag: 6)
Size.create(name: "23.5cm以下", category_flag: 7)
Size.create(name: "24cm", category_flag: 7)
Size.create(name: "24.5cm", category_flag: 7)
Size.create(name: "25cm", category_flag: 7)
Size.create(name: "25.5cm", category_flag: 7)
Size.create(name: "26cm", category_flag: 7)
Size.create(name: "26.5cm", category_flag: 7)
Size.create(name: "27cm", category_flag: 7)
Size.create(name: "27.5cm", category_flag: 7)
Size.create(name: "28cm", category_flag: 7)
Size.create(name: "28.5cm", category_flag: 7)
Size.create(name: "29cm", category_flag: 7)
Size.create(name: "29.5cm", category_flag: 7)
Size.create(name: "30cm", category_flag: 7)
Size.create(name: "30.5cm", category_flag: 7)
Size.create(name: "31cm以上", category_flag: 7)
Size.create(name: "140cm~", category_flag: 8)
Size.create(name: "150cm~", category_flag: 8)
Size.create(name: "160cm~", category_flag: 8)
Size.create(name: "170cm~", category_flag: 8)
Size.create(name: "スキーボード", category_flag: 8)
Size.create(name: "子供用", category_flag: 8)
Size.create(name: "その他", category_flag: 8)
Size.create(name: "12インチ", category_flag: 9)
Size.create(name: "13インチ", category_flag: 9)
Size.create(name: "14インチ", category_flag: 9)
Size.create(name: "15インチ", category_flag: 9)
Size.create(name: "16インチ", category_flag: 9)
Size.create(name: "17インチ", category_flag: 9)
Size.create(name: "18インチ", category_flag: 9)
Size.create(name: "19インチ", category_flag: 9)
Size.create(name: "20インチ", category_flag: 9)
Size.create(name: "21インチ", category_flag: 9)
Size.create(name: "22インチ", category_flag: 9)
Size.create(name: "23インチ", category_flag: 9)
Size.create(name: "24インチ", category_flag: 9)
Size.create(name: "50cc以下", category_flag: 10)
Size.create(name: "51cc-125cc", category_flag: 10)
Size.create(name: "126cc-250cc", category_flag: 10)
Size.create(name: "251cc-400cc", category_flag: 10)
Size.create(name: "401cc-750cc", category_flag: 10)
Size.create(name: "751cc以上", category_flag: 10)
Size.create(name: "XSサイズ以下", category_flag: 11)
Size.create(name: "Sサイズ", category_flag: 11)
Size.create(name: "Mサイズ", category_flag: 11)
Size.create(name: "Lサイズ", category_flag: 11)
Size.create(name: "XLサイズ", category_flag: 11)
Size.create(name: "XXLサイズ以上", category_flag: 11)
Size.create(name: "フリーサイズ", category_flag: 11)
Size.create(name: "子供用", category_flag: 11)
...
lady_tops.children.create([{name: "Tシャツ/カットソー(半袖/袖なし)", size_flag: 1},{name: "Tシャツ/カットソー(七分/長袖)", size_flag: 1},{name: "シャツ/ブラウス(半袖/袖なし)", size_flag: 1},{name: "シャツ/ブラウス(七分/長袖)", size_flag: 1},{name: "ポロシャツ", size_flag: 1},{name: "キャミソール", size_flag: 1},{name: "タンクトップ", size_flag: 1},{name: "ホルターネック", size_flag: 1},{name: "ニット/セーター", size_flag: 1},{name: "チュニック", size_flag: 1},{name: "カーディガン/ボレロ", size_flag: 1},{name: "アンサンブル", size_flag: 1},{name: "ベスト/ジレ", size_flag: 1},{name: "パーカー", size_flag: 1},{name: "トレーナー/スウェット", size_flag: 1},{name: "ベアトップ/チューブトップ", size_flag: 1},{name: "ジャージ", size_flag: 1},{name: "その他", size_flag: 1}])

lady_jacket = lady.children.create(name: "ジャケット/アウター")
lady_jacket.children.create([{name: "テーラードジャケット", size_flag: 1},{name: "ノーカラージャケット", size_flag: 1},{name: "Gジャン/デニムジャケット", size_flag: 1},{name: "レザージャケット", size_flag: 1},{name: "ダウンジャケット", size_flag: 1},{name: "ライダースジャケット", size_flag: 1},{name: "ミリタリージャケット", size_flag: 1},{name: "ダウンベスト", size_flag: 1},{name: "ジャンパー/ブルゾン", size_flag: 1},{name: "ポンチョ", size_flag: 1},{name: "ロングコート", size_flag: 1},{name: "トレンチコート", size_flag: 1},{name: "ダッフルコート", size_flag: 1},{name: "ピーコート", size_flag: 1},{name: "チェスターコート", size_flag: 1},{name: "モッズコート", size_flag: 1},{name: "スタジャン", size_flag: 1},{name: "毛皮/ファーコート", size_flag: 1},{name: "スプリングコート", size_flag: 1},{name: "スカジャン", size_flag: 1},{name: "その他", size_flag: 1}])

lady_pants = lady.children.create(name: "パンツ")
lady_pants.children.create([{name: "デニム/ジーンズ", size_flag: 1},{name: "ショートパンツ", size_flag: 1},{name: "カジュアルパンツ", size_flag: 1},{name: "ハーフパンツ", size_flag: 1},{name: "チノパン", size_flag: 1},{name: "ワークパンツ/カーゴパンツ", size_flag: 1},{name: "クロップドパンツ", size_flag: 1},{name: "サロペット/オーバーオール", size_flag: 1},{name: "オールインワン", size_flag: 1},{name: "サルエルパンツ", size_flag: 1},{name: "ガウチョパンツ", size_flag: 1},{name: "その他", size_flag: 1}])

lady_skirt = lady.children.create(name: "スカート")
lady_skirt.children.create([{name: "ミニスカート", size_flag: 1},{name: "ひざ丈スカート", size_flag: 1},{name: "ロングスカート", size_flag: 1},{name: "キュロット", size_flag: 1},{name: "その他", size_flag: 1}])

lady_onepiece = lady.children.create(name: "ワンピース")
lady_onepiece.children.create([{name: "ミニワンピース", size_flag: 1},{name: "ひざ丈ワンピース", size_flag: 1},{name: "ロングワンピース", size_flag: 1},{name: "その他", size_flag: 1}])

lady_shoes = lady.children.create(name: "靴")
lady_shoes.children.create([{name: "ハイヒール/パンプス", size_flag: 2},{name: "ブーツ", size_flag: 2},{name: "サンダル", size_flag: 2},{name: "スニーカー", size_flag: 2},{name: "ミュール", size_flag: 2},{name: "モカシン", size_flag: 2},{name: "ローファー/革靴", size_flag: 2},{name: "フラットシューズ/バレエシューズ", size_flag: 2},{name: "長靴/レインシューズ", size_flag: 2},{name: "その他", size_flag: 2}])

lady_pajamas = lady.children.create(name: "ルームウェア/パジャマ")
lady_pajamas.children.create([{name: "パジャマ", size_flag: 1},{name: "ルームウェア", size_flag: 1}])
...
lady_yukata.children.create([{name: "浴衣"},{name: "着物"},{name: "振袖"},{name: "長襦袢/半襦袢"},{name: "水着セパレート", size_flag: 1},{name: "水着ワンピース", size_flag: 1},{name: "水着スポーツ用", size_flag: 1},{name: "その他"}])

lady_formal = lady.children.create(name: "スーツ/フォーマル/ドレス")
lady_formal.children.create([{name: "スカートスーツ上下", size_flag: 1},{name: "パンツスーツ上下", size_flag: 1},{name: "ドレス", size_flag: 1},{name: "パーティーバッグ"},{name: "シューズ"},{name: "ウェデング"},{name: "その他"}])

lady_maternity = lady.children.create(name: "マタニティ")
lady_maternity.children.create([{name: "トップス", size_flag: 1},{name: "アウター", size_flag: 1},{name: "インナー", size_flag: 1},{name: "ワンピース", size_flag: 1},{name: "パンツ/スパッツ", size_flag: 1},{name: "スカート", size_flag: 1},{name: "パジャマ", size_flag: 1},{name: "授乳服", size_flag: 1},{name: "その他"}])
...
man_tops.children.create([{name: "Tシャツ/カットソー(半袖/袖なし)", size_flag: 1},{name: "Tシャツ/カットソー(七分/長袖)", size_flag: 1},{name: "シャツ", size_flag: 1},{name: "ポロシャツ", size_flag: 1},{name: "タンクトップ", size_flag: 1},{name: "ニット/セーター", size_flag: 1},{name: "パーカー", size_flag: 1},{name: "カーディガン", size_flag: 1},{name: "スウェット", size_flag: 1},{name: "ジャージ", size_flag: 1},{name: "ベスト", size_flag: 1},{name: "その他", size_flag: 1}])

man_jacket = man.children.create(name: "ジャケット/アウター")
man_jacket.children.create([{name: "テーラードジャケット", size_flag: 1},{name: "ノーカラージャケット", size_flag: 1},{name: "Gジャン/デニムジャケット", size_flag: 1},{name: "レザージャケット", size_flag: 1},{name: "ダウンジャケット", size_flag: 1},{name: "ライダースジャケット", size_flag: 1},{name: "ミリタリージャケット", size_flag: 1},{name: "ナイロンジャケット", size_flag: 1},{name: "フライトジャケット", size_flag: 1},{name: "ダッフルコート", size_flag: 1},{name: "ピーコート", size_flag: 1},{name: "ステンカラーコート", size_flag: 1},{name: "トレンチコート", size_flag: 1},{name: "モッズコート", size_flag: 1},{name: "チェスターコート", size_flag: 1},{name: "スタジャン", size_flag: 1},{name: "スカジャン", size_flag: 1},{name: "ブルゾン", size_flag: 1},{name: "マウンテンパーカー", size_flag: 1},{name: "ダウンベスト", size_flag: 1},{name: "ポンチョ", size_flag: 1},{name: "カバーオール", size_flag: 1},{name: "その他", size_flag: 1}])

man_pants = man.children.create(name: "パンツ")
man_pants.children.create([{name: "デニム/ジーンズ", size_flag: 1},{name: "ワークパンツ/カーゴパンツ", size_flag: 1},{name: "スラックス", size_flag: 1},{name: "チノパン", size_flag: 1},{name: "ショートパンツ", size_flag: 1},{name: "ペインターパンツ", size_flag: 1},{name: "サルエルパンツ", size_flag: 1},{name: "オーバーオール", size_flag: 1},{name: "その他", size_flag: 1}])

man_shoes = man.children.create(name: "靴")
man_shoes.children.create([{name: "スニーカー", size_flag: 7},{name: "サンダル", size_flag: 7},{name: "ブーツ", size_flag: 7},{name: "モカシン", size_flag: 7},{name: "ドレス/ビジネス", size_flag: 7},{name: "長靴/レインシューズ", size_flag: 7},{name: "デッキシューズ", size_flag: 7},{name: "その他", size_flag: 7}])
...
man_suit.children.create([{name: "スーツジャケット", size_flag: 1},{name: "スーツベスト", size_flag: 1},{name: "スラックス", size_flag: 1},{name: "セットアップ", size_flag: 1},{name: "その他"}])
...
man_swimwear.children.create([{name: "一般水着", size_flag: 1},{name: "スポーツ用", size_flag: 1},{name: "アクセサリー"}, {name: "その他"}])
...
man_under.children.create([{name: "トランクス", size_flag: 1},{name: "ボクサーパンツ", size_flag: 1}, {name: "その他"}])

man_other = man.children.create(name: "その他")


kids_baby_girl = kids.children.create(name: "ベビー服(女の子用)~95cm")
kids_baby_girl.children.create([{name: "トップス", size_flag: 3},{name: "アウター", size_flag: 3},{name: "パンツ", size_flag: 3},{name: "スカート", size_flag: 3},{name: "ワンピース", size_flag: 3},{name: "ベビードレス", size_flag: 3},{name: "おくるみ", size_flag: 3},{name: "下着/肌着", size_flag: 3},{name: "パジャマ", size_flag: 3},{name: "ロンパース", size_flag: 3},{name: "その他", size_flag: 3}])

kids_baby_boy = kids.children.create(name: "ベビー服(男の子用)~95cm")
kids_baby_boy.children.create([{name: "トップス", size_flag: 3},{name: "アウター", size_flag: 3},{name: "パンツ", size_flag: 3},{name: "おくるみ", size_flag: 3},{name: "下着/肌着", size_flag: 3},{name: "パジャマ", size_flag: 3},{name: "ロンパース", size_flag: 3},{name: "その他", size_flag: 3}])

kids_baby_both = kids.children.create(name: "ベビー服(男女兼用)~95cm")
kids_baby_both.children.create([{name: "トップス", size_flag: 3},{name: "アウター", size_flag: 3},{name: "パンツ", size_flag: 3},{name: "おくるみ", size_flag: 3},{name: "下着/肌着", size_flag: 3},{name: "パジャマ", size_flag: 3},{name: "ロンパース", size_flag: 3},{name: "その他", size_flag: 3}])

kids_girl = kids.children.create(name: "キッズ服(女の子用)100cm~")
kids_girl.children.create([{name: "コート", size_flag: 4},{name: "ジャケット/上着", size_flag: 4},{name: "トップス(Tシャツ/カットソー)", size_flag: 4},{name: "トップス(トレーナー)", size_flag: 4},{name: "トップス(チュニック)", size_flag: 4},{name: "トップス(タンクトップ)", size_flag: 4},{name: "トップス(その他)", size_flag: 4},{name: "スカート", size_flag: 4},{name: "パンツ", size_flag: 4},{name: "ワンピース", size_flag: 4},{name: "セットアップ", size_flag: 4},{name: "パジャマ", size_flag: 4},{name: "フォーマル/ドレス", size_flag: 4},{name: "和服", size_flag: 4},{name: "浴衣", size_flag: 4},{name: "甚平", size_flag: 4},{name: "水着", size_flag: 4},{name: "その他", size_flag: 4}])

kids_boy = kids.children.create(name: "キッズ服(男の子用)100cm~")
kids_boy.children.create([{name: "コート", size_flag: 4},{name: "ジャケット/上着", size_flag: 4},{name: "トップス(Tシャツ/カットソー)", size_flag: 4},{name: "トップス(トレーナー)", size_flag: 4},{name: "トップス(その他)", size_flag: 4},{name: "パンツ", size_flag: 4},{name: "セットアップ", size_flag: 4},{name: "パジャマ", size_flag: 4},{name: "フォーマル/ドレス", size_flag: 4},{name: "和服", size_flag: 4},{name: "浴衣", size_flag: 4},{name: "甚平", size_flag: 4},{name: "水着", size_flag: 4},{name: "その他", size_flag: 4}])

kids_both = kids.children.create(name: "キッズ服(男女兼用)100cm~")
kids_both.children.create([{name: "コート", size_flag: 4},{name: "ジャケット/上着", size_flag: 4},{name: "トップス(Tシャツ/カットソー)", size_flag: 4},{name: "トップス(トレーナー)", size_flag: 4},{name: "トップス(その他)", size_flag: 4},{name: "ボトムス", size_flag: 4},{name: "パジャマ", size_flag: 4},{name: "その他", size_flag: 4}])

kids_shoes = kids.children.create(name: "キッズ靴")
kids_shoes.children.create([{name: "スニーカー", size_flag: 5},{name: "サンダル", size_flag: 5},{name: "ブーツ", size_flag: 5},{name: "長靴", size_flag: 5},{name: "その他", size_flag: 5}])
...
sports_snowboard.children.create([{name: "ボード",size_flag: 6},{name: "バインディング"},{name: "ブーツ(男性用)",size_flag: 7},{name: "ブーツ(女性用)",size_flag: 2},{name: "ブーツ(子ども用)",size_flag: 5},{name: "ウエア/装備(男性用)",size_flag: 1},{name: "ウエア/装備(女性用)",size_flag: 1},{name: "ウエア/装備(子ども用)",size_flag: 4},{name: "アクセサリー"},{name: "バッグ"},{name: "その他"}])

sports_ski = sports.children.create(name: "スキー")
sports_ski.children.create([{name: "板",size_flag: 8},{name: "ブーツ(男性用)",size_flag: 7},{name: "ブーツ(女性用)",size_flag: 2},{name: "ブーツ(子ども用)",size_flag: 5},{name: "ビンディング"},{name: "ウエア(男性用)",size_flag: 1},{name: "ウエア(女性用)",size_flag: 1},{name: "ウエア(子ども用)",size_flag: 4},{name: "ストック"},{name: "その他"}])
...
car_tire.children.create([{name: "タイヤ/ホイールセット",size_flag: 9},{name: "タイヤ",size_flag: 9},{name: "ホイール",size_flag: 9},{name: "その他"}])
...
car_motorcycle_body = car.children.create(name: "オートバイ車体",size_flag: 10)
...
car_motorcycle_accessories.children.create([{name: "ヘルメット/シールド",size_flag: 11},{name: "バイクウエア/装備"},{name: "アクセサリー"},{name: "メンテナンス"},{name: "カタログ/マニュアル"},{name: "その他"}])
